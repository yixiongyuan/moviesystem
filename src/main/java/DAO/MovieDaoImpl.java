...
public class MovieDaoImpl implements  MovieDAO{
    ...
    public int movieCount(){
        String SQL = "select count(*) from movie_list";
    ...
    public int movieSearchCount(String filter, String condition) {
        String SQL = "select count(*) from movie_list where "+filter+" like ?";
        Connection conn = null;
    ...
    public List<Movie> listMovies(int start,int size){
        String SQL = "select * from movie_list order by movie_id DESC LIMIT  ? , ?";
    ...
    public List<Movie> searchMovies(String filter, String condition, int start, int size) {
        String SQL = "select * from movie_list where "+filter+" like ? order by movie_id DESC LIMIT  ? , ?";
        List<Movie> list = new ArrayList<>();
        Connection conn = null;
    ...
    public int addMovie(Movie movie) {
        String SQL = "insert into movie_list (name,director,year,actors,label) values (?,?,?,?,?)";

        String SQLID = "select max(movie_id) from movie_list";
    ...
    public void delMovie(int id) {
        String SQL = "delete from movie_list where movie_id =  ? ";
    ...
    public Movie searchMovieById(int id) {
        String SQL = "select * from movie_list where movie_id =  ? ";
    ...
    public void updateMovie(Movie movie) {
        String SQL = "UPDATE movie_list SET name=?,director=?,year=?,actors=?,label=?,cover=? where movie_id =  ? ";
    ...
    public void addCoverMovie(Movie movie) {
        ...
        String SQL = "UPDATE movie_list SET cover=? where movie_id = ? ";
    ...
    public void addScoreMovie(int score, Movie movie) {
        ...
        String SQL = "UPDATE movie_list SET rating_times=?,total_score=?,avg_score=? where movie_id =  ? ";
    ...
    public void addReviewMovie(Movie movie) {
        ...
        String SQL = "UPDATE movie_list SET review=? where movie_id = ? ";
