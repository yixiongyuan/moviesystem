...
<section class="page-section" id="contact">
    ...
    <div class="container">
        ...
        <h2 class="page-section-heading-search text-center text-uppercase text-secondary mb-0">Update Movie Info</h2>
        <!-- Icon Divider-->
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-xl-7">
                <form:form modelAttribute="movie" action="${pageContext.request.getContextPath()}/update?movieId=${movie.id}"   enctype="multipart/form-data" method="post">
                    ...
                    <!-- year input-->
                    <div class="form-floating mb-3">
                        <td><form:input cssClass="form-control" path="year" type = "number"/></td>
                    ...
                    <form:hidden  path="cover" value="${movie.cover}"/>
